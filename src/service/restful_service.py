...
class RestfulService:
    ...
    def _make_request(self, method: str, url: str, payload: Optional[Union[Dict[str, Any], str]] = None, 
                     timeout: Optional[int] = None, headers: Optional[Dict[str, str]] = None) -> requests.Response:
        if timeout is None:
    ...
    def get(self, url: str, timeout: Optional[int] = None, headers: Optional[Dict[str, str]] = None) -> requests.Response:
        return self._make_request('GET', url, timeout=timeout, headers=headers)
        
    def post(self, url: str, payload: Optional[Union[Dict[str, Any], str]] = None, 
             timeout: Optional[int] = None, headers: Optional[Dict[str, str]] = None) -> requests.Response:
        return self._make_request('POST', url, payload=payload, timeout=timeout, headers=headers)
        
    def put(self, url: str, payload: Optional[Union[Dict[str, Any], str]] = None, 
            timeout: Optional[int] = None, headers: Optional[Dict[str, str]] = None) -> requests.Response:
        return self._make_request('PUT', url, payload=payload, timeout=timeout, headers=headers)
        
    def delete(self, url: str, timeout: Optional[int] = None, headers: Optional[Dict[str, str]] = None) -> requests.Response:
